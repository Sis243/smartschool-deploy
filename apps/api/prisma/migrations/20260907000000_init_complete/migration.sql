...
-- CreateEnum
CREATE TYPE "StatutPreuve" AS ENUM ('EN_ATTENTE', 'VALIDE', 'REJETE');
...
CREATE TABLE "parents" (
    ...
    "pin" TEXT,
    "accessCode" TEXT,
    "portalActif" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "presences" (
    ...
    "methode" "MethodePointage" NOT NULL DEFAULT 'MANUEL',
...
CREATE TABLE "preuves_paiement" (
    ...
    "fichierUrl" TEXT,
    "fichierNom" TEXT,
    "statut" "StatutPreuve" NOT NULL DEFAULT 'EN_ATTENTE',
    "noteAdmin" TEXT,
    "validePar" TEXT,
...
CREATE TABLE "notifs_parent" (
    ...
    CONSTRAINT "notifs_parent_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "preuves_paiement" ADD CONSTRAINT "preuves_paiement_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "preuves_paiement" ADD CONSTRAINT "preuves_paiement_factureId_fkey" FOREIGN KEY ("factureId") REFERENCES "factures"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "preuves_paiement" ADD CONSTRAINT "preuves_paiement_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "parents"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "notifs_parent" ADD CONSTRAINT "notifs_parent_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "notifs_parent" ADD CONSTRAINT "notifs_parent_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "parents"("id") ON DELETE CASCADE ON UPDATE CASCADE;
