// Modules payants activables/désactivables par école. Reste hors de cette
// liste le socle toujours actif : Élèves, Notes, Académique, Utilisateurs.
// Miroir côté frontend : apps/web/src/lib/modules.ts (garder synchronisé).
